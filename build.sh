...
echo "  3. Package Chrome: zip -r return-yt-live-subscriptions-0.2.0.zip build/chrome/*"
echo "  4. Package Firefox: zip -r return-yt-live-subscriptions-firefox-0.2.0.zip build/firefox/*"
